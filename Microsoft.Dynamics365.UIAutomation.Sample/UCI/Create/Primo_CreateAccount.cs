...
{
    [TestClass]
    public class PrimoCreateAccountUCI
    {
        ...
        [TestMethod]
        public void Primo_TestCreateAccount()
        {
            ...
            using (var xrmApp = new XrmApp(client))
            {
                ...
                client.Browser.Driver.FindElement(By.XPath("//*[@aria-label='Customer Group, Lookup']")).Click();
                xrmApp.ThinkTime(3000);

                client.Browser.Driver.FindElement(By.XPath("//span[@class='symbolFont SearchButton-symbol cm cg dm ']")).Click();
                xrmApp.ThinkTime(3000);

                client.Browser.Driver.FindElement(By.XPath("//*[@aria-label='Test CG 2']")).Click();
                xrmApp.ThinkTime(3000);
